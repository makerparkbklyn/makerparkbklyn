...
const principlesKeyframes = {
	...
	scenes: [
		...
		},
		{
			...
			duration:	4800,
			offset	:	1.6 * wh,
			element :	'.principles__item:nth-child(1)',
			tween	: 	[
							{y: 1.2 * wh},
		...
		},
		{
			...
			duration:	4800,
			offset	:	1.7 * wh,
			element :	'.principles__item:nth-child(2)',
			tween	: 	[
							{y: 1.2 * wh},
							{y: -wh, ease: Power2.easeInOut}
						]
		},
		{
			...
			duration:	4800,
			offset	:	1.85 * wh,
			element :	'.principles__item:nth-child(3)',
			tween	: 	[
							{y: 1.2 * wh},
							{y: -wh, ease: Power2.easeInOut}
						]
		},
		{
			...
			duration:	4800,
			offset	:	1.95 * wh,
			element :	'.principles__item:nth-child(4)',
			tween	: 	[
							{y: 1.2 * wh},
							{y: -wh, ease: Power2.easeInOut}
						]
		},
		{
			...
			duration:	4800,
			offset	:	2.1 * wh,
			element :	'.principles__item:nth-child(5)',
			tween	: 	[
							{y: 1.2 * wh},
							{y: -wh, ease: Power2.easeInOut}
						]
		},
		{
			...
			duration:	4800,
			offset	:	2.2 * wh,
			element :	'.principles__item:nth-child(6)',
			tween	: 	[
							{y: 1.2 * wh},
							{y: -wh, ease: Power2.easeInOut}
						]
		},
		{
			...
			duration:	4800,
			offset	:	2.35 * wh,
			element :	'.principles__item:nth-child(7)',
			tween	: 	[
							{y: 1.2 * wh},
							{y: -wh, ease: Power2.easeInOut}
						]
		},
		{
			...
			duration:	4800,
			offset	:	2.45 * wh,
			element :	'.principles__item:nth-child(8)',
			tween	: 	[
							{y: 1.2 * wh},
							{y: -wh, ease: Power2.easeInOut}
						]
		},
		{
			...
			duration:	4800,
			offset	:	2.6 * wh,
			element :	'.principles__item:nth-child(9)',
			tween	: 	[
							{y: 1.2 * wh},
							{y: -wh, ease: Power2.easeInOut}
						]
		},
		{
			...
			duration:	4800,
			offset	:	2.7 * wh,
			element :	'.principles__item:nth-child(10)',
			tween	: 	[
							{y: 1.2 * wh},
							{y: -wh, ease: Power2.easeInOut}
						]
